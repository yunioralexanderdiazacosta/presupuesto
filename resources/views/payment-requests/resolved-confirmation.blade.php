...
<head>
    ...
    <title>Solicitud Gestionada</title>
    <style>
        ...
        .success-icon { font-size: 72px; color: #00d27a; margin-bottom: 20px; }
        h1 { color: #00d27a; margin-bottom: 10px; }
        .number { font-size: 24px; color: #2c7be5; font-weight: bold; margin: 20px 0; }
...
<body>
    <div class="container">
        ...
        <p>
            Marcaste esta solicitud de pago como gestionada, {{ $resolvedByName }}.<br>
