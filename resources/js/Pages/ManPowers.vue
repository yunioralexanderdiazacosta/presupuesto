...
const openEdit = (manPower) => {
    ...
    form.investment_id = manPower.investment_id;
...
<Table sticky-header :id="'manPowers'" :total="filteredManPowers.length" :links="manPowers.links">
                            ...
                            <template #body>
                                ...
                                <template v-else>
                                    <tr v-for="(manPower, index) in filteredManPowers" :key="index">
                                        ...
                                        <td>{{ manPower.investment ? manPower.investment.name : '—' }}</td>
                                        <td>
                    ...
                    <div  class="mb-3 d-flex align-items-end gap-2 flex-wrap">
                      ...
                      <div class="col-auto">
                        ...
                        <select v-model="selectedProduct" class="form-select form-select-sm" style="min-width: 180px; max-width: 220px;">
                          <option value="">Todos</option>
                                    ...
                                    <template v-for="(cc, index) in filteredData3" :key="index">
                                        <template v-for="(subfamily, index2) in cc.subfamilies" :key="index2">
                                            <tr>
                                                ...
                                                <td class="col-month col-amount" v-for="value in subfamily.products[0].months" :key="value">{{value}}</td>
                                            </tr>
                                            ...
                                            <template v-for="(product, index3) in subfamily.products" :key="index3">
                                                <tr v-if="index3 > 0">
                                                    ...
                                                    <td class="col-month col-amount" v-for="value in product.months" :key="value">{{value}}</td>
                                                </tr>
                                            </template>
                                        </template>
                                    </template>
                        ...
                        <div class="mb-3 row g-2 align-items-end flex-wrap">
                          <div class="col d-flex justify-content-end align-items-end gap-1">
                            <ExportExcelButton
                              ...
                              class="btn btn-success btn-md d-flex align-items-center p-0"
                              filename="ManoDeObra-ResumenEstado.xlsx"
                            />
                            <ExportPdfButton
                              :data="excelDataResumen"
                              :headers="[
                              ...
                              class="btn btn-danger btn-md d-flex align-items-center p-0"
                              filename="ManoDeObra-ResumenEstado.pdf"
                            />
                          </div>
                        </div>
