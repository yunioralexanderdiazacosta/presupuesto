...
watch(selectedBranch, (val) => {
    router.get(route('fields.index'), { branch_id: val || '', tab: activeTab.value }, { preserveState: false, replace: true });
});
            ...
            <div class="card-header">
                <div class="row flex-between-center">
                    <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                      <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-tree text-primary me-2"></i>General Campo</h5>
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="pill-tab-edicion" role="tabpanel" aria-labelledby="edicion-tab">
                        ...
                        <Table sticky-header :id="'fields'" :total="filteredFields.length" :links="fields.links">
                            ...
                            <template #header>
                                ...
                                <th scope="col" width="min-w-100px">Sucursal</th>
                                ...
                                <template v-else>
                                    <tr v-for="(field, index) in filteredFields" :key="index">
                                        ...
                                        <td class="text-muted" style="font-size:0.8rem;">
                                            {{ branches.find(b => String(b.value) === String(field.branch_id))?.label ?? '—' }}
                                        </td>
                            ...
                            <div class="col-md-4 col-lg-2 col-xl-2 col-xxl-2">
                              <div class="card h-100 p-1 small-card">
                                ...
                                <div class="card-body d-flex flex-column justify-content-end py-1 px-2">
                                  <div class="row">
                                    <div class="col">
                                      <p class="font-sans-serif lh-1 mb-1 fs-8 small-card-number">{{ percentageField }}%</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="mb-3 row g-2 align-items-end flex-wrap">
                          <div class="col d-flex justify-content-end align-items-end gap-1">
                            <ExportExcelButton
                              ...
                              class="btn btn-success btn-md d-flex align-items-center p-0"
                              filename="GeneralesCampo-ResumenHa.xlsx"
                            />
                            <ExportPdfButton
                              :data="excelDataResumen"
                              :headers="[
                              ...
                              class="btn btn-danger btn-md d-flex align-items-center p-0"
                              filename="GeneralesCampo-ResumenHa.pdf"
                            />
                          </div>
                        </div>
