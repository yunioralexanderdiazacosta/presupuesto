...
<template>
    <Head :title="title" />
        <div class="row flex-center min-vh-100 py-6">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-0" href="../../../index.html"><img class="me-0 mb-4" :src=" path + '/assets/img/icons/spot-illustrations/alisoft.png'" alt="" width="88" /><span class="font-sans-serif text-primary fw-bolder fs-4 d-inline-block">Alisoft</span></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="row flex-between-center mb-2">
                 ...
                 <form @submit.prevent="submit">
                  <div class="mb-3">
                    <input class="form-control" type="text" name="username" v-model="form.username" required autofocus autocomplete="username" placeholder="Usuario" :class="{'is-invalid': form.errors.username}" />
