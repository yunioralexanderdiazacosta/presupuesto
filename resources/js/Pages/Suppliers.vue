...
const onFilter = () => {
  router.get(route('suppliers.index', {term: term.value}), { preserveState: true});  
}
</script>
<template>
    <Head :title="title" />
                ...
                <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <button type="button" @click="openAdd()" class="btn btn-sm fw-bold btn-primary">Agregar proveedor</button>
                        </div>
                        <!--end::Actions-->
                    </div>
                    ...
                    <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header mt-6">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        <!--begin::Export-->
                                        <a :href="route('suppliers.pdf', {term: term})" target="_blank" class="btn btn-light-primary me-3">
                                       ...
                                       <!--begin::Export-->
                                        <a :href="route('suppliers.excel', {term: term})" target="_blank" class="btn btn-light-primary me-3">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr078.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1" transform="rotate(90 12.75 4.25)" fill="currentColor" />
                            ...
                            <div class="card-body pt-0">
                                <Table :id="'providers'" :total="suppliers.data.length" :links="suppliers.links">
                                    <!--begin::Table head-->
                                    <template #header>
                                        <!--begin::Table row-->
                                    ...
                                    <!--begin::Table body-->
                                    <template #body>
                                        <template v-if="suppliers.total == 0">
                                            <Empty colspan="4" />
                                        </template>
                                        <template v-else>
                                            <tr v-for="(supplier, index) in suppliers.data" :key="index">
                                                ...
                                                <td class="text-end">
                                                    <!--begin::Update-->
                                                    <button type="button" v-tooltip="'Editar'" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" @click="openEdit(supplier)">
                                                    ...
                                                    <!--end::Update-->
                                                    <!--begin::Delete-->
                                                    <button type="button" v-tooltip="'Eliminar'" @click="onDeleted(supplier.id)" class="btn btn-icon btn-active-light-primary w-30px h-30px">
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
