...
const deleteOutflow = (outflowId) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route('fertilizer-outflows.delete', outflowId), {
                onSuccess: () => {
...
const excelData = computed(() => {
    return props.outflows.data.map(item => ({
        'Fecha': item.date,
        'Orden': `#${item.fertilizer_order_id}`,
                ...
                <div class="row flex-between-center">
                    <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                        <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">
                            <i class="fas fa-seedling me-2"></i>Aplicaciones de Fertilizantes
                        </h5>
                    </div>
                    <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                        <div class="d-flex align-items-center gap-2">
                            <ExportExcelButton 
                                :data="excelData"
                                filename="aplicaciones-fertilizantes"
