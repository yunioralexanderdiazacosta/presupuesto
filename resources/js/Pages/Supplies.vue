                                ...
                                <div class="tab-content pt-3">                            
                                                ...
                                                <template v-else>
                                                    <tr v-for="(supply, index) in supplies.data" :key="index">
                                                        ...
                                                        <td class="text-end text-center">
                                                            <!--begin::Update-->
                                                            <button type="button" @click="openEdit(supply)" v-tooltip="'Editar'" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                                                            ...
                                                            <!--end::Update-->
                                                            <!--begin::Delete-->
                                                            <button type="button" v-tooltip="'Eliminar'" @click="onDeleted(supply.id)" class="btn btn-icon btn-active-light-primary w-30px h-30px">
                                                                <span class="svg-icon svg-icon-3">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="tab-pane" id="kt_table_2" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table id="table_4" class="table table-row-full-dashed table-row-gray-400 align-middle gs-0 gy-2">
                                                <!--begin::Table head-->
                                                <thead>
