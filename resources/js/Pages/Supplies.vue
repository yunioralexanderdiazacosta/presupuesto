...
const openEdit = (supply) => {
    ...
    form.investment_id = supply.investment_id;
            ...
            <div class="card-header">
                <div class="row flex-between-center">
                    <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                      <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-city text-primary me-2"></i>Insumos</h5>
                    </div>
                            ...
                            <template #body>
                                ...
                                <template v-else>
                                    <tr v-for="(supply, index) in filteredSupplies" :key="index">
                                        ...
                                        <td>{{ supply.investment ? supply.investment.name : '—' }}</td>
                                        <td>
                         ...
                         <div class="col-auto">
                          ...
                          <div class="col d-flex justify-content-end align-items-end gap-1">
                            <ExportExcelButton
                              ...
                              class="btn btn-success btn-md d-flex align-items-center p-0"
                              filename="Insumos-Detalles.xlsx"
                            />
                          </div>
                        </div>

                        <div class="table-responsive budget-table-wrapper mt-1">
                            <table id="table_4" class="table budget-tbl">
                                <!--begin::Table head-->
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        <th v-if="!hideCc" class="yunior min-w-150px">Centro de costo</th>
                                        <th>Subfamilia</th>
                        ...
                        <div class="mb-3 d-flex align-items-end gap-2 flex-wrap">
                          ...
                          <div class="col d-flex justify-content-end align-items-end gap-1">
                            <ExportExcelButton
                              ...
                              class="btn btn-success btn-md d-flex align-items-center p-0"
                              filename="Insumos-GastosPorHectarea.xlsx"
                            />
                          </div>
                        </div>
                        ...
                        <div class="mb-3 row g-2 align-items-end flex-wrap">
                          <div class="col d-flex justify-content-end align-items-end gap-1">
                            <ExportExcelButton
                              ...
                              class="btn btn-success btn-md d-flex align-items-center p-0"
                              filename="Insumos-ResumenEstado.xlsx"
                            />
                            <ExportPdfButton
                              :data="excelDataResumen"
                              :headers="[
                              ...
                              class="btn btn-danger btn-md d-flex align-items-center p-0"
                              filename="Insumos-ResumenEstado.pdf"
                            />
                          </div>
                        </div>
