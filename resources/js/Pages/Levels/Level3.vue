...
const links = [{ title: 'Tablero', link: 'dashboard' }, {title: 'Niveles', link: 'levels.index' }, {title: 'Nivel 2', link: 'level2.index', params: [props.level2.level1_id]}, { title: title, active: true }];
...
const updateLevel = () => {
    form.post(route('level3.update', form.id), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset();
...
const onDeleted = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route('level3.delete', id), {
                preserveScroll: true,
                onSuccess: () => {
    ...
    <AppLayout>
        ...
        <div class="card my-3">
            <div class="card-header">
                <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                        <h5 class="mb-0" data-anchor="data-anchor">Nivel 3</h5>
                    </div>
                    <div class="col-auto ms-auto">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <!--begin::Import-->
                            <button type="button" v-if="total == 0" @click="importLevel()" class="btn btn-light-primary me-3">
                           ...
                           <!--begin::Export-->
                            <a :href="route('levels3.excel', {level2: $page.props.level2.id, term: term})" target="_blank" class="btn btn-light-primary me-3">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr078.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1" transform="rotate(90 12.75 4.25)" fill="currentColor" />
            ...
            <div class="card-body pt-0"> 
                ...
                <Table :id="'level3'" :total="levels.data.length" :links="levels.links">
                    <!--begin::Table head-->
                    <template #header>
                        <!--begin::Table row-->
        ...
        <CreateSubLevelModal @store="storeLevel" :form="form" :level="'Nivel 3'" />
        <EditSubLevelModal @update="updateLevel" :form="form" :level="'Nivel 3'" />
    </AppLayout>
</template>