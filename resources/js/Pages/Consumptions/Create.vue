...
const title = 'Registrar Consumo';
const links = [
  { title: 'Tablero', link: 'dashboard' },
  { title: 'Consumos', link: 'consumptions.index' },
...
function save() {
  form.post(route('consumptions.store'), {
    ...
    onSuccess: () => {
      ...
      // Redirigir a index si se desea, como en invoices
      // router.get(route('consumptions.index'));
    }
  });
}
  ...
  <AppLayout>
    ...
    <div class="card my-1 mx-1 px-1">
      ...
      <div class="card-body bg-body-tertiary">
        <form id="kt_consumption_form" @submit.prevent="save()">
          <!--begin::Form-->
          <ConsumptionForm
            :mode="'create'"
            :form="form"
          ...
          <div class="mb-0 text-end">
            <button type="submit" class="btn btn-primary mt-3" id="kt_consumption_submit_button">
