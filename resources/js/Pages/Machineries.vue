...
import CreateMachineryModal from '@/Components/Machineries/CreateMachineryModal.vue';
...
const openEdit = (machinery) => {
    form.reset();
    form.id = machinery.id;
...
const storeMachinery = () => {
    form.post(route('machineries.store'), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset();
            $('#createMachineryModal').modal('hide');
...
const updateMachinery = () => {
    form.post(route('machineries.update', form.id), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset();
            $('#editMachineryModal').modal('hide');
            msgSuccess('Guardado correctamente');
        }
    });
}
...
const onDeleted = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route('machineries.delete', id), {
                preserveScroll: true,
                onSuccess: () => {
...
<template>
    ...
    <AppLayout>
                ...
                <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <button type="button" @click="openAdd()" class="btn btn-sm fw-bold btn-primary">Agregar maquinaria</button>
                        </div>
                        <!--end::Actions-->
                    </div>
                    ...
                    <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header mt-6">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        <!--begin::Export-->
                                        <a :href="route('machineries.pdf', {term: term})" target="_blank" class="btn btn-light-primary me-3">
                                       ...
                                       <!--begin::Export-->
                                        <a :href="route('machineries.excel', {term: term})" target="_blank" class="btn btn-light-primary me-3">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr078.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1" transform="rotate(90 12.75 4.25)" fill="currentColor" />
                            ...
                            <div class="card-body pt-0">
                                <Table :id="'providers'" :total="machineries.data.length" :links="machineries.links">
                                    <!--begin::Table head-->
                                    <template #header>
                                        <!--begin::Table row-->
                                    ...
                                    <template #body>
                                        ...
                                        <template v-else>
                                            <tr v-for="(machinery, index) in machineries.data" :key="index">
                                                ...
                                                <td class="text-end">
                                                    <!--begin::Update-->
                                                    <button type="button" v-tooltip="'Editar'" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" @click="openEdit(machinery)">
                                                    ...
                                                    <!--end::Update-->
                                                    <!--begin::Delete-->
                                                    <button type="button" v-tooltip="'Eliminar'" @click="onDeleted(machinery.id)" class="btn btn-icon btn-active-light-primary w-30px h-30px">
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <CreateMachineryModal @store="storeMachinery" :form="form" />
        <EditMachineryModal @update="updateMachinery" :form="form" />
    </AppLayout>
</template>