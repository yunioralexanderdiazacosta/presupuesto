...
<template>
    <Modal :maxWidth="'xl'" :dialogStyle="'max-width: 88vw; width: 88vw;'" :id="'editAgrochemicalModal'">
        <template #header>
            <div class="d-flex align-items-center gap-2 mb-3 text-start">
                ...
                <span>
                    <span class="fw-bold" style="font-size: 1.2rem; color: #2d3748; letter-spacing: 0.5px;">Editar un agroquímico</span>
                    <br>
