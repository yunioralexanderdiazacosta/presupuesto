    ...
    <Modal :maxWidth="'lg'" :id="'createUserModal'">
        <template #header>
            <div class="d-flex align-items-center gap-2 mb-3 text-start">
                ...
                <span>
                    <span class="fw-bold" style="font-size: 1.2rem; color: #2d3748; letter-spacing: 0.5px;">Agregar usuario</span>
                    <br>
                    <span class="text-muted" style="font-size: 0.85rem;">Completa los datos del usuario</span>
                </span>
            </div>
        </template>
        <template #body>
        ...
        <template #footer>
            ...
            <button type="button" @click="$emit('store')" :disabled="form.processing" id="kt_modal_add_user_submit" class="btn btn-primary">
