...
<template>
    <Modal :maxWidth="'xl'" :id="'editHarvestModal'">
        ...
        <template #footer>
            <button type="button" id="kt_modal_update_harvest_cancel" data-bs-dismiss="modal" class="btn btn-light me-3">Cerrar</button>
            <button type="button" @click="$emit('update')" :disabled="form.processing" id="kt_modal_update_harvest_submit" class="btn btn-primary">
