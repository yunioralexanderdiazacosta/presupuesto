...
function save() {
    form.post(route('overtime-hours.store'), {
        onSuccess: () => {
            Swal.fire({ icon: 'success', title: 'Guardado', text: 'Hora extra registrada correctamente.', timer: 1200, showConfirmButton: false });
            form.reset();
            emit('saved');
        },
        onError: () => {
            ...
            <div class="modal-content" style="background-color: #f8f9fa;">
                <div class="modal-header bg-white border-bottom">
                    <h5 class="modal-title d-flex align-items-center">
                        <i class="fas fa-clock text-primary me-2 fs-8"></i>
                        Nueva Hora Extra
                    </h5>
