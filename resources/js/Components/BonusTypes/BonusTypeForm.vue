        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" v-model="form.name" class="form-control form-control-sm"
                    :class="{ 'is-invalid': form.errors?.name }" placeholder="Ej: Bono poda, Bono cosecha" />
                <div v-if="form.errors?.name" class="invalid-feedback">{{ form.errors.name }}</div>
            </div>
            <div class="col-md-4">
                <label class="form-label small mb-1">Monto Referencia ($)</label>
                <input type="number" v-model="form.default_amount" class="form-control form-control-sm"
                    placeholder="0" min="0" />
            </div>
            <div class="col-md-2">
