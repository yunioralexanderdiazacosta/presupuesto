    ...
    <Modal :maxWidth="'xl'" :id="'editCostCenterModal'">
        <template #header>
            <div class="d-flex align-items-center gap-2 mb-3 text-start">
                ...
                <span>
                    <span class="fw-bold" style="font-size: 1.2rem; color: #2d3748; letter-spacing: 0.5px;">Editar centro de costo</span>
                    <br>
                    <span class="text-muted" style="font-size: 0.85rem;">Modificar los datos del centro de costo</span>
                </span>
            </div>
        </template>
        <template #body>
