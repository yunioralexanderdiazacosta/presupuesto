...
<template>
    <Modal :maxWidth="'xl'" :dialogStyle="'max-width: 88vw; width: 88vw;'" :id="'createManPowerModal'">
        <template #header>
        ...
        <template #footer>
            <button type="button" id="kt_modal_add_agrochemical_cancel" data-bs-dismiss="modal" class="btn btn-light me-3">Cerrar</button>
