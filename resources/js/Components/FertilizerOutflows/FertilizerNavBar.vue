...
const tabs = [
    { label: 'Órdenes de Fertilizante', route: 'fertilizer-orders.index', icon: 'fas fa-clipboard-list' },
    { label: 'Registro de Aplicaciones', route: 'fertilizer-outflows.index', icon: 'fas fa-seedling' },
];
        ...
        <nav class="d-flex align-items-center px-2 py-1 rounded" style="background-color: #f9fafb; border: 1px solid #a3d9a5; border-radius: 10px !important;">
            ...
            <div class="d-flex align-items-center flex-grow-1">
                <Link
                    ...
                    class="fertilizer-tab flex-fill text-center"
...
.fertilizer-tab:hover {
    color: #2c7be5;
    background-color: rgba(44, 123, 229, 0.08);
}

.fertilizer-tab.active {
    color: #fff;
