...
return new class extends Migration
{
    ...
    {
        Schema::create('application_order_cost_center', function (Blueprint $table) {
            $table->id();
            ...
            // Evitar duplicados
            $table->unique(['application_order_id', 'cost_center_id'], 'app_order_cc_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('application_order_cost_center');
    }
};
