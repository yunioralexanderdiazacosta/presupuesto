...
/**
    ...
    
    {
        ...
        $totalAbsolute = round($this->totalData2) + round($this->totalAgrochemical) + round($this->totalManPower) + round($this->totalSupplies) + round($this->totalServices)+ round($totalAdministration) + round($totalField);
