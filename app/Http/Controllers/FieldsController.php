...
class FieldsController extends Controller
{
    ...
    public function __invoke()
    {
        ...
        $fields = Field::with(['subfamily:id,name', 'unit:id,name', 'level2:id,name', 'items'])
        ->paginate(10)
        ...
        $data = Field::from('fields as f')
        ->join('level2s as l2', 'f.level2_id', 'l2.id')
        ...
        ->transform(function($value) use ($team_id){
            return [
                ...
                'total'        => $this->getTotal($value->id, $team_id)
            ];
        });


        $data2 = Field::from('fields as f')
        ...
        return Inertia::render('Fields', compact('units', 'level2s', 'months', 'fields','data', 'data2'));
    }
