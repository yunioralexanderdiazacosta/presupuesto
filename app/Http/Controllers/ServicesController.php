...
class ServicesController extends Controller
{
    ...
    public function __invoke()
    {
        ...
        $totalAbsolute = round($this->totalData2) + round($this->totalFertilizer) + round($this->totalManPower) + round($this->totalAgrochemical) + round($this->totalSupplies);
        ...
        return Inertia::render('Services', compact('units', 'subfamilies', 'months', 'costCenters', 'services', 'data', 'data2', 'data3', 'season', 'totalData1', 'totalData2', 'percentage'));
    }
